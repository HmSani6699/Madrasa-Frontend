          ...
          <div className="px-6 md:px-12 pb-10">
            <div className="flex flex-col md:flex-row items-end gap-6 -mt-12 md:-mt-20 relative z-10 mb-8">
              ...
              <div className="text-center md:text-left mb-2 flex-1">
                <h1 className="text-2xl md:text-4xl font-black text-slate-800 uppercase tracking-tight leading-none mb-2">
                  Abdullah Mamun
                </h1>
                <div className="flex flex-wrap justify-center md:justify-start items-center gap-4 text-slate-500 font-bold text-xs md:text-base">
                  ...
                  <span className="flex items-center gap-2">
                    ID: <Fingerprint className="w-4 h-4 text-black" /> 26010082
                  </span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8 border-t border-slate-100">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center gap-4 p-5 bg-slate-50/50 rounded-2xl border border-slate-100 group hover:border-slate-200 transition-all"
                >
                  <div
                    className={`w-12 h-12 ${stat.bg} ${stat.color} rounded-xl flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform`}
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-1 space-y-4">
            <button className="w-full flex items-center justify-between p-6 bg-slate-900 text-white rounded-3xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-slate-200">
              <span className="flex items-center gap-4">
                <User className="w-5 h-5" /> Student Bio
              </span>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-12 border border-slate-200 shadow-sm animate-in slide-in-from-right duration-500">
              <h3 className="text-2xl font-black text-slate-800 uppercase tracking-tight mb-10">
              ...
              <div className="mt-12 p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                ...
                <div className="flex flex-wrap gap-4">
                  {["Hifz Completed", "Sports Captain", "Best Attendance"].map(
                    (tag, i) => (
                      <span
                        key={i}
                        className="px-6 py-3 bg-white border border-slate-200 rounded-xl text-[10px] font-black text-slate-600 uppercase tracking-widest shadow-sm"
                      >
                        {tag}
                      </span>
                    )
