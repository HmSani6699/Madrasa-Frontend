...
const PaySalary = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-8 animate-in fade-in duration-500">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-slate-800">Pay Salary</h1>
        <p className="text-slate-500">Search for a empolyee to collect dues.</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row gap-4 items-center">
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            placeholder="Search by Employee ID, Name or Roll Number..."
            value={searchTerm}
        ...
        <button
          ...
          className="px-8 py-3 bg-primary text-white font-bold rounded-xl shadow-lg shadow-primary/20 hover:scale-105 transition-transform w-full md:w-auto cursor-pointer"
        >
          Find Employe
        </button>
      </div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      if (e.target.value) {
                        ...
                        const newFee = {
                          id: newFeeId,
                          head: `Monthly Tuition (${e.target.value})`,
                          amount: 1000,
                          isPaid: false,
                        };
              ...
              <div className="p-4 bg-slate-50 border-t border-slate-200">
                <div className="flex justify-between items-center text-slate-600">
                  <span className="text-sm font-bold">Subtotal (Selected)</span>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="number"
                    className={`w-full mt-1 p-3 border rounded-xl font-bold text-2xl focus:outline-none focus:ring-2 transition-all ${
                      paidVal < grandTotal && paidVal > 0
                        ? "border-amber-300 ring-amber-100 text-amber-700"
                        : "border-slate-200 focus:ring-primary/20 text-emerald-700"
                    }`}
                    placeholder="0"
                    value={paidAmount}
                ...
                {grandTotal > 0 && (
                  <div
                    className={`p-4 rounded-xl text-sm font-bold flex justify-between items-center ${
                      paidVal < grandTotal
                  ...
                  >
                    <span>
                      {paidVal < grandTotal ? "Remaining Due" : "Status"}
                    </span>
                    <span className="text-lg">
                      {paidVal < grandTotal ? `৳ ${due}` : "Fully Paid"}
                    </span>
                  </div>
                )}
              ...
              <button className="w-full py-4 bg-emerald-600 text-white font-bold rounded-xl shadow-lg shadow-emerald-200 hover:bg-emerald-700 transition-all flex items-center justify-center gap-2">
