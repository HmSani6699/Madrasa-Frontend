      ...
      <div className="max-w-[1600px] mx-auto space-y-8">
        ...
        <div className="bg-white rounded-[1.5rem] md:rounded-[2.5rem] border border-slate-200 p-6 md:p-8 shadow-sm flex flex-col lg:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <div>
              ...
              <p className="text-slate-500 font-bold mt-0.5 text-xs md:text-base">Design, assign and evaluate student coursework across all your classes</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 w-full lg:w-auto mt-4 lg:mt-0">
            <button 
               ...
               className="flex-1 lg:flex-none px-6 md:px-10 py-3.5 md:py-4 bg-blue-600 text-white rounded-xl md:rounded-2xl font-black shadow-xl shadow-blue-100 hover:bg-blue-700 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-3 uppercase tracking-widest text-[10px] md:text-[11px]"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
           <div className="bg-white rounded-2xl md:rounded-[2rem] border border-slate-200 p-5 md:p-6 shadow-sm">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 md:mb-3 block">Search Title</label>
              <div className="relative">
                 <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-300" />
                 <input className="w-full bg-slate-50 border border-slate-100 rounded-xl pl-10 pr-4 py-2.5 text-sm font-bold focus:border-blue-500 outline-none transition-all" placeholder="Enter keyword..." />
              </div>
           </div>
           <div className="bg-white rounded-2xl md:rounded-[2rem] border border-slate-200 p-5 md:p-6 shadow-sm">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 md:mb-3 block">Filter Class</label>
              <div className="relative">
                 <Users className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-300" />
                 <select className="w-full bg-slate-50 border border-slate-100 rounded-xl pl-10 pr-4 py-2.5 text-sm font-bold focus:border-blue-500 outline-none appearance-none cursor-pointer">
                    <option>All My Classes</option>
                    <option>Hifz - Sec A</option>
                    <option>Mishkat - Sec B</option>
                 </select>
                 <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-300 pointer-events-none" />
              </div>
           </div>
           <div className="bg-white rounded-2xl md:rounded-[2rem] border border-slate-200 p-5 md:p-6 shadow-sm">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 md:mb-3 block">Timeline</label>
              <div className="flex gap-2">
                 <button className="flex-1 py-2.5 bg-blue-50 text-blue-600 rounded-xl text-[10px] font-black uppercase tracking-widest border border-blue-100">Live</button>
                 <button className="flex-1 py-2.5 bg-slate-50 text-slate-400 rounded-xl text-[10px] font-black uppercase tracking-widest border border-slate-100">Drafts</button>
              </div>
           </div>
           <div className="bg-slate-900 rounded-2xl md:rounded-[2rem] p-5 md:p-6 shadow-lg shadow-slate-100 flex items-center justify-center">
              <button className="w-full h-full text-white font-black uppercase tracking-widest text-[10px] flex items-center justify-center gap-2">
              ...
              <table className="w-full border-collapse min-w-[800px]">
                 <thead>
                    <tr className="border-b border-slate-50 text-[10px] font-black text-slate-400 uppercase tracking-widest">
                       <th className="px-6 md:px-10 py-4 md:py-6 text-left">Assignment Details</th>
                       <th className="px-6 md:px-10 py-4 md:py-6 text-left">Class / Section</th>
                       <th className="px-6 md:px-10 py-4 md:py-6 text-center">Dates</th>
                       <th className="px-6 md:px-10 py-4 md:py-6 text-center">Submissions</th>
                 ...
                 <tbody className="divide-y divide-slate-50">
                    {homeworks.map((hw) => (
                       <tr key={hw.id} className="group hover:bg-slate-50/50 transition-all">
                          ...
                          <td className="px-6 md:px-10 py-4 md:py-6 font-black text-slate-600 text-xs md:text-sm uppercase">{hw.class}</td>
             ...
             <div className="p-6 md:p-10">
                <div className="flex items-center justify-between mb-8">
                   <div className="flex items-center gap-4">
                      ...
                      <div>
                         ...
                         <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Assign new coursework to your students</p>
                      </div>
                   </div>
                   <button 
                      onClick={() => setShowModal(false)}
                ...
                <div className="space-y-6">
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                         ...
                         <div className="relative">
                            <Users className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-300" />
                            <select className="w-full bg-slate-50 border border-slate-100 rounded-2xl pl-10 pr-4 py-3.5 text-sm font-bold focus:border-blue-500 outline-none appearance-none">
                               <option>Hifz - Section A</option>
                               <option>Mishkat - Section B</option>
                            </select>
                         </div>
                      </div>
                      <div className="space-y-2">
                   ...
                   <div className="space-y-2">
                      ...
                      <input className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-3.5 text-sm font-bold focus:border-blue-500 outline-none" placeholder="e.g. Verb Conjugation Exercise" />
                   </div>

                   <div className="space-y-2">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1">Detailed Instructions</label>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                         ...
                         <div className="relative">
                            ...
                            <input type="date" className="w-full bg-slate-50 border border-slate-100 rounded-2xl pl-10 pr-6 py-3.5 text-sm font-bold focus:border-blue-500 outline-none" />
                         </div>
                      </div>
                      <div className="flex items-end">
                         <button className="flex items-center justify-center gap-3 p-3.5 bg-slate-100 border border-slate-200 rounded-2xl text-[10px] font-black text-slate-400 uppercase tracking-widest hover:bg-slate-200 transition-all w-full h-[54px]">
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-4">
                   ...
                   <button 
                      ...
                      className="flex-1 py-4 bg-blue-600 text-white rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-xl shadow-blue-100 hover:bg-blue-700 transition-all"
                   >
                      Publish Assignment
                   </button>
                </div>
