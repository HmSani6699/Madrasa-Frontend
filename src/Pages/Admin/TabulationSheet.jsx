      ...
      <div className="bg-white rounded-[2.5rem] border-2 border-slate-200 p-8 flex flex-col md:flex-row justify-between items-center gap-6 shadow-sm">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-slate-500 font-bold mt-1">Comprehensive mark sheet and result analysis</p>
          </div>
        </div>

        <div className="flex gap-4">
           <button className="px-6 py-4 bg-white border-2 border-slate-200 text-slate-600 rounded-2xl font-black shadow-sm hover:border-[#00bd7f] hover:text-[#00bd7f] transition-all flex items-center justify-center gap-3">
             <Printer className="w-5 h-5" />
             Print
           </button>
           <button className="px-6 py-4 bg-[#00bd7f] text-white rounded-2xl font-black shadow-xl shadow-emerald-200 hover:bg-[#009b68] transition-all flex items-center justify-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="space-y-2">
               ...
               <div className="space-y-2">
                ...
                <div className="relative group">
                    <select className="w-full bg-slate-50 border-2 border-slate-100 rounded-xl px-4 py-3 text-sm font-bold focus:border-[#00bd7f] outline-none appearance-none cursor-pointer transition-all">
              ...
              <div className="flex items-end">
                <button className="w-full py-3.5 bg-slate-800 text-white rounded-xl font-black uppercase tracking-widest text-[10px] shadow-lg hover:bg-slate-700 transition-all flex items-center justify-center gap-2">
          ...
          <table className="w-full border-collapse">
              <thead>
                <tr className="bg-slate-50/50 text-[10px] font-black text-slate-400 uppercase tracking-widest">
                    <th className="px-8 py-6 text-left border-r-2 border-slate-100 sticky left-0 bg-slate-50/50 z-10">Student Particulars</th>
                    <th className="px-4 py-6 text-center border-r border-slate-100 min-w-[80px]">Quran</th>
                    <th className="px-4 py-6 text-center border-r border-slate-100 min-w-[80px]">Hadith</th>
                    <th className="px-4 py-6 text-center border-r border-slate-100 min-w-[80px]">Fiqh</th>
                    <th className="px-4 py-6 text-center border-r border-slate-100 min-w-[80px]">Arabic</th>
                    <th className="px-4 py-6 text-center border-r border-slate-100 min-w-[80px]">English</th>
                    <th className="px-4 py-6 text-center border-r border-slate-100 bg-[#f0f9f6] text-[#00bd7f]">Grand Total</th>
                    <th className="px-4 py-6 text-center border-r border-slate-100">GPA</th>
              ...
              <tbody className="divide-y-2 divide-slate-50">
                {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                    <tr key={i} className="group hover:bg-emerald-50/10 transition-all">
                      <td className="px-8 py-6 border-r-2 border-slate-50 bg-white group-hover:bg-emerald-50/10 sticky left-0 z-10">
                          <div className="flex items-center gap-4">
                            <div className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center font-black text-slate-400 group-hover:bg-[#e6f4ef] group-hover:text-[#00bd7f] transition-all text-xs">
                              {i < 10 ? `0${i}` : i}
                            </div>
                            <div>
                                <p className="text-sm font-black text-slate-800 tracking-tight">Abdullah Al-Mamun</p>
                                <p className="text-[10px] font-bold text-slate-400 tracking-widest">ROLL: 2026.0{i}</p>
                            </div>
                          </div>
                      </td>
