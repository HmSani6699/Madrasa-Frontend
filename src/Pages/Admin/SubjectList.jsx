...
const SubjectList = () => {
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-500 p-6 md:p-5">
      {/* Header */}
      <div className="bg-white rounded-[20px] border-2 border-slate-200 p-10 flex flex-col lg:flex-row justify-between items-center gap-8 shadow-sm relative overflow-hidden">
      ...
      {/* Search + Filter */}
      <div className="bg-white/80 backdrop-blur-xl p-8 rounded-[20px] border border-slate-100 shadow-xl flex flex-col lg:flex-row gap-6 items-center">
        {/* Large Search Box */}
        <div className="relative flex-1 w-full group">
          <div className="absolute inset-y-0 left-6 flex items-center">
            <Search className="w-6 h-6 text-slate-300 group-focus-within:text-[#00bd7f] transition-colors" />
          </div>
          ...
          <input
            ...
            className="w-full pl-16 pr-6 py-5 bg-slate-50 border-2 border-slate-100 rounded-[1.8rem] text-base font-bold outline-none 
      focus:border-[#00bd7f] focus:bg-white text-slate-800 transition-all shadow-inner 
      placeholder:text-slate-400"
        ...
        <div className="relative w-full lg:w-[220px] shrink-0">
          <button
            ...
            className="w-full px-6 py-5 bg-white border-2 border-slate-100 rounded-[1.8rem] text-sm font-black text-slate-700 flex items-center justify-between 
      hover:border-[#00bd7f] transition-all shadow-sm"
          >
            <span className="flex items-center gap-2">
              <Filter className="w-4 h-4 text-slate-400" />
              {levelFilter || "Select Tier"}
            </span>
            <ChevronDown
          ...
          {openFilter && (
            <div className="absolute mt-3 w-full bg-white rounded-2xl shadow-2xl border-2 border-slate-50 z-50 py-2 animate-in fade-in slide-in-from-top-2">
              {levels.map((l) => (
                <button
                  key={l}
                  onClick={() => {
                  ...
                  className={`w-full text-left px-6 py-3 text-xs font-black transition-colors ${
                    levelFilter === l
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-slate-50/50">
              <tr>
                <th className="px-10 py-4 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">
                  Subject Identity
                </th>
                <th className="px-10 py-4 text-center text-[10px] font-black text-slate-400 uppercase tracking-widest">
                  Academic Tier
                </th>
                <th className="px-10 py-4 text-center text-[10px] font-black text-slate-400 uppercase tracking-widest">
                  Classification
                ...
                <th className="px-10 py-4 text-right text-[10px] font-black text-slate-400 uppercase tracking-widest">
                  Management
                </th>
              </tr>
            </thead>
