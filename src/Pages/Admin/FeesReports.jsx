      ...
      <div className="max-w-[1600px] mx-auto space-y-8">
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-200 p-8 shadow-sm flex flex-col lg:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-black text-slate-800 tracking-tight text-uppercase">
                Fees Reports
              </h1>
              <p className="text-slate-500 font-bold mt-1">
                Detailed financial analysis of student fees.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 w-full lg:w-auto">
            ...
            <button className="flex-[2] lg:flex-none px-8 py-4 bg-emerald-500 text-white rounded-2xl font-black shadow-xl shadow-emerald-100 hover:bg-emerald-700 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-3 uppercase tracking-widest text-[11px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-[2.5rem] border border-slate-200 p-8 shadow-sm flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 text-emerald-500 text-[10px] font-black uppercase">
              <div className="w-2 h-2 rounded-full bg-emerald-500"></div> +8.2%
              vs Last Month
            </div>
          </div>
          <div className="bg-white rounded-[2.5rem] border border-slate-200 p-8 shadow-sm flex flex-col gap-4">
        ...
        <div className="bg-white rounded-[3rem] border border-slate-200 p-10 shadow-sm space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-3 flex items-end">
              <button className="w-full py-4 bg-emerald-500 text-white rounded-2xl font-black uppercase tracking-widest text-[11px] shadow-xl shadow-slate-200">
                Apply Filter & Fetch
              </button>
            </div>
          </div>
                ...
                {[1, 2, 3, 4].map((i) => (
                  ...
                  >
                    <td className="px-8 py-6 whitespace-nowrap">
                      <span className="text-xs font-black text-slate-400 font-mono tracking-tighter uppercase">
                        INV-0987-0{i}
                      </span>
                    </td>
                    <td className="px-8 py-6 whitespace-nowrap">
