    ...
    setClasses(
      classes.map((c) =>
        c.id === selectedClass.id
          ? { ...c, sections: [...c.sections, newSectionName] }
          : c,
      ),
    );
    ...
    <div className="space-y-8 animate-in fade-in duration-500 p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        {[
          ...
          <div
            key={i}
            className="bg-white p-6 rounded-3xl border-2 border-slate-100 shadow-sm flex items-center gap-4"
          >
            <div
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        {filteredClasses.map((cls) => (
          <div
            key={cls.id}
            className="group bg-white rounded-[2rem] border-2 border-slate-200 shadow-sm hover:shadow-xl hover:border-[#00bd7f]/30 transition-all duration-300 flex flex-col"
          >
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {cls.sections.map((sec, idx) => (
                    <div
                      key={idx}
                      className="px-4 py-2 bg-slate-50 border-2 border-slate-100 rounded-xl text-xs font-black text-slate-600 flex items-center gap-2 group/sec"
                    >
        ...
        >
          ...
          <p className="text-lg font-black text-slate-400 group-hover:text-slate-600">
            Create New Class
          </p>
        </button>
      </div>
          ...
          <div className="bg-white rounded-[2.5rem] w-full max-w-lg shadow-2xl animate-in zoom-in duration-300 overflow-hidden">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="pt-4 flex gap-4">
                ...
                <button
                  onClick={
                    isEditClassModalOpen ? handleEditClass : handleAddClass
                  }
      ...
      {isAddSectionModalOpen && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-white rounded-[20px] w-full max-w-sm shadow-2xl animate-in zoom-in duration-300 overflow-hidden">
            <div className="p-5 border-b-2 border-slate-50 flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-slate-400">
                    Detailed overview of academic tier
                  </p>
                </div>
              </div>
              <button
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-[9px] font-black rounded border border-emerald-100 uppercase">
                      Capacity OK
                    </span>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {selectedClass?.sections.map((s, idx) => (
                    <div
                      key={idx}
                      className="p-4 bg-slate-50 rounded-2xl border-2 border-slate-100 flex items-center justify-between group"
                    >
                      <div className="flex items-center gap-3">
                      ...
                      <span className="text-[9px] font-black text-slate-300 uppercase opacity-0 group-hover:opacity-100 transition-opacity tracking-widest">
                        Subscribed
                      </span>
                    </div>
                  ))}
