...
const ClassSchedule = () => {
  ...
  const colors = [
    ...
    {
      name: "Slate (Break)",
      value: "bg-slate-50 border-slate-100 text-slate-400",
    },
  ];
  ...
  const [scheduleData, setScheduleData] = useState([
    ...
    },
    {
      ...
      class: "Class 5",
      section: "Section A",
      color: "bg-slate-50 border-slate-100 text-slate-400",
    },
    {
      id: 5,
      day: "Saturday",
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 p-4 md:p-8">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-slate-50/50">
                <th className="p-6 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest border-r-2 border-slate-100 w-48 sticky left-0 bg-slate-50 z-10 whitespace-nowrap">
                  Time / Day
                </th>
                {days.map((day) => (
                  <th
                    key={day}
                    className="p-6 text-center text-[10px] font-black text-slate-600 uppercase tracking-widest min-w-[220px]"
                  >
                    {day}
                  </th>
                ))}
                  ...
                  {days.map((day) => {
                    ...
                    if (!period)
                      return (
                        <td
                          key={day}
                          className="p-4 relative group/cell whitespace-nowrap"
                        >
                          <div
                    ...
                    return (
                      <td key={day} className="p-4">
                        <div
                          className={`p-5 rounded-3xl border-2 transition-all hover:scale-[1.02] hover:shadow-lg h-28 flex flex-col justify-center relative group/card ${period.color}`}
                        >
                          <p className="text-sm font-black truncate pr-4">
                            {period.subject}
                          </p>
      ...
      <Modal
        ...
        title={currentSlot?.id ? "Edit Schedule " : "Add New Schedule"}
      >
          ...
          {currentSlot?.isBreak ? (
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setCurrentSlot({ ...currentSlot, label: e.target.value })
                }
