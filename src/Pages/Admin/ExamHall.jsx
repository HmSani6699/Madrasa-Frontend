            ...
            <tbody className="divide-y-2 divide-slate-50">
              {halls.map((hall) => (
                ...
                >
                  ...
                  <td className="px-8 py-6 text-center">
                    <span
                      className={`inline-flex items-center gap-1.5 px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest border-2 ${
          ...
          <div className="bg-white rounded-[3rem] w-full max-w-xl shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="pt-6 flex gap-4">
                ...
                <button
                  onClick={() => setIsModalOpen(false)}
                  className="flex-1 py-4 bg-blue-600 text-white font-black rounded-2xl shadow-xl shadow-blue-200"
                >
                  Save Venue
                </button>
              </div>
