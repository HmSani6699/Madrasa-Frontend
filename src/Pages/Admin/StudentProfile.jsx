...
const StudentProfile = () => {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-500 p-4 sm:p-6 lg:p-10 bg-slate-50/50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 no-print">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-[#00315e] text-white font-bold rounded-[8px] shadow-lg  hover:scale-[1.02] transition-all cursor-pointer"
          >
          ...
          <div className="flex-1 text-center lg:text-left space-y-4">
            <div>
              <div className="flex flex-col sm:flex-row items-center gap-3 mb-2">
                ...
                <span className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border-2 ${student.status === 'active'
      ...
      {/* Tabs Navigation */}
      <div className="flex flex-wrap gap-2 bg-[#e6f4ef] p-1.5 rounded-full w-fit mx-auto no-print justify-center">
        {tabs.map((tab) => (
          <button
            key={tab.id}
            onClick={() => setActiveTab(tab.id)}
            className={`cursor-pointer flex items-center gap-2 px-6 py-3 rounded-full text-sm font-bold transition-all ${activeTab === tab.id
              ? 'bg-[#00315e] text-white shadow-lg'
      ...
      <div className="space-y-8 animate-in slide-in-from-bottom-5 duration-700">
        ...
        {activeTab === "personal" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-8 rounded-[15px] shadow-sm space-y-6">
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="bg-white p-6 rounded-[8px]  shadow-sm flex items-center justify-between">
                  <div>
        ...
        {activeTab === "academic" && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white p-8 rounded-[15px] shadow-sm space-y-6 text-center">
        ...
        {activeTab === "documents" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="bg-white p-4 rounded-[8px] shadow-sm hover:border-[#00bd7f] transition-all group cursor-pointer">
