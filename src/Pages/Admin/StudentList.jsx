  ...
  const students = useMemo(
    () => [
      ...
      },
      {
        ...
        email: "stu2@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU2",
        admissionDate: "2025-01-12",
        bloodGroup: "O+",
        guardian: "মোহাম্মদ আলী",
      },
      {
        id: "STU2025003",
        firstName: "ইউসুফ",
        ...
        email: "stu3@mms.com",
        status: "inactive",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU3",
        admissionDate: "2025-01-15",
        bloodGroup: "B+",
        guardian: "হোসেন আহমেদ",
      },
      {
        id: "STU2025004",
        firstName: "ফাতিমা",
        ...
        email: "stu4@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU4",
        admissionDate: "2025-01-18",
        bloodGroup: "AB+",
        guardian: "আব্দুল্লাহ মাহমুদ",
      },
      {
        id: "STU2025005",
        firstName: "আব্দুল্লাহ",
        lastName: "মামুন",
        gender: "Male",
        class: "Class 6",
        section: "Section A",
        ...
        email: "stu5@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU5",
        admissionDate: "2025-01-20",
        bloodGroup: "A-",
        guardian: "সাইফুল ইসলাম",
      },
      {
        id: "STU2025006",
        firstName: "সুরাইয়া",
        ...
        email: "stu6@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU6",
        admissionDate: "2025-01-22",
        bloodGroup: "B-",
        guardian: "জসিম উদ্দিন",
      },
      {
        id: "STU2025007",
        firstName: "ওমর",
        ...
        email: "stu7@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU7",
      ...
      },
      {
        ...
        email: "stu8@mms.com",
        status: "inactive",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU8",
        admissionDate: "2025-01-28",
        bloodGroup: "A+",
        guardian: "রেজাউল করিম",
      },
      {
        id: "STU2025009",
        firstName: "ইব্রাহিম",
        ...
        email: "stu9@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU9",
        admissionDate: "2025-01-30",
        bloodGroup: "B+",
        guardian: "নুরুল ইসলাম",
      },
      {
        id: "STU2025010",
        firstName: "মারিয়া",
        ...
        email: "stu10@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU10",
        admissionDate: "2025-02-01",
        bloodGroup: "O+",
        guardian: "শাহাদাত হোসেন",
      },
      {
        id: "STU2025011",
        firstName: "হাসান",
        ...
        email: "stu11@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU11",
        admissionDate: "2025-02-05",
        bloodGroup: "A+",
        guardian: "ফয়সাল আহমেদ",
      },
      {
        id: "STU2025012",
        firstName: "তাসনিম",
        ...
        email: "stu12@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU12",
      ...
      },
      {
        ...
        email: "stu13@mms.com",
        status: "inactive",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU13",
      ...
      },
      {
        ...
        email: "stu14@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU14",
        admissionDate: "2025-02-12",
        bloodGroup: "O+",
        guardian: "হারুনুর রশিদ",
      },
      {
        id: "STU2025015",
        firstName: "আবু",
        ...
        email: "stu15@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU15",
        admissionDate: "2025-02-15",
        bloodGroup: "A-",
        guardian: "মতিউর রহমান",
      },
      {
        id: "STU2025016",
        firstName: "জান্নাতুল",
        ...
        email: "stu16@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU16",
        admissionDate: "2025-02-18",
        bloodGroup: "B-",
        guardian: "সুলতান আহমেদ",
      },
      {
        id: "STU2025017",
        firstName: "মুসা",
        ...
        email: "stu17@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU17",
        admissionDate: "2025-02-20",
        bloodGroup: "O-",
        guardian: "ইকবাল হোসেন",
      },
      {
        id: "STU2025018",
        firstName: "রোকাইয়া",
        ...
        email: "stu18@mms.com",
        status: "inactive",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU18",
        admissionDate: "2025-02-22",
        bloodGroup: "A+",
        guardian: "কামাল উদ্দিন",
      },
      {
        id: "STU2025019",
        firstName: "তালহা",
        ...
        email: "stu19@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU19",
      ...
      },
      {
        ...
        email: "stu20@mms.com",
        status: "active",
        photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=STU20",
        admissionDate: "2025-02-28",
        bloodGroup: "O+",
        guardian: "আমজাদ হোসেন",
      },
    ],
    []
  );
        ...
        <div className="p-8 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-slate-50 border-2 border-slate-100 rounded-xl text-sm font-bold text-slate-500"
                disabled
              />
            </div>
            <div>
          ...
          <div className="pt-6 flex justify-end gap-3">
            ...
            <button
              ...
              className="px-8 py-2.5 bg-[#00bd7f] text-white text-sm font-bold rounded-xl shadow-lg shadow-emerald-200"
            >
              Save Changes
            </button>
          </div>
    ...
    >
      ...
      <div className="p-6 flex justify-center gap-3 bg-white">
        ...
        <button
          ...
          className="px-8 py-2.5 bg-rose-600 text-white text-sm font-bold rounded-xl shadow-lg shadow-rose-200 hover:bg-rose-700"
        >
          Delete Now
        </button>
      </div>
